...
public interface FindPlacesInterface extends Types, Statuses {
     ...
     * A API KEY
     */
    String API_KEY = "AIzaSyDtS5nYWh9bMAdmdofOfKOkfkPe3SG_qxk";
   ...
   // List<Place> getNearbyPlaces(double lat, double lng, double radius, Param... extraParams);
     ...
     * {@link com.ttu.spm.appsum.places.exception.GooglePlacesException} will be thrown.
     *
     * @param place_results place_results
     * @param limit  the maximum amount of places to return
     ...
     * @throws com.ttu.spm.appsum.places.exception.GooglePlacesException if 'keyword', 'name' or 'types' is not included.
     */
