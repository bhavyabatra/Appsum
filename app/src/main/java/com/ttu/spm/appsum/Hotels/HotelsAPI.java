...
import com.ttu.spm.appsum.places.DefaultRequestHandler;
...
public class HotelsAPI implements HotelsAPIInterface {
    ...
    public HotelsAPI(String apiKey) {
        this(apiKey, new com.ttu.spm.appsum.places.DefaultRequestHandler());
    }
...
try{
    ...
    public List<HotelDetails> getNearbyPlaces(double lat, double lng, double radius, int limit, Accomadations.HotelResults hotel_results,Params... extraParams) {
        try {
            String uri = buildUrl(METHOD_NEARBY_SEARCH, String.format(Locale.ENGLISH, "key=%s&location=%f,%f&radius=%f&type=lodging&keyword=attractions&rankby=prominence",
